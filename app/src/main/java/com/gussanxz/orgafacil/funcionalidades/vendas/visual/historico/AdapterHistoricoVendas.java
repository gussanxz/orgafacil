...
public class AdapterHistoricoVendas extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    class VendaViewHolder extends RecyclerView.ViewHolder {
        ...
        private final TextView    txtVendaCliente;
        ...
        VendaViewHolder(@NonNull View itemView) {
            ...
            txtVendaCliente    = itemView.findViewById(R.id.txtVendaCliente);
        ...
        void bind(VendaModel venda) {
            ...
            if (txtVendaCliente != null) {
                String cliente = venda.getClienteNome();
                txtVendaCliente.setText(cliente != null && !cliente.trim().isEmpty()
                        ? "Cliente " + cliente
                        : "Venda avulsa");
            }
